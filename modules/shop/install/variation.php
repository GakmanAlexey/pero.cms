...
class Variation  extends \Modules\Abs\Install{
    ...
    public function install_BD(){
        $table = [];
        $table[] = '
            CREATE TABLE '.\Modules\Core\Modul\Env::get("DB_PREFIX").'variation (
            ...
            PRIMARY KEY (`id`),
            UNIQUE KEY `'.\Modules\Core\Modul\Env::get("DB_PREFIX").'product_variations_external_guid_unique` (`external_guid`),
