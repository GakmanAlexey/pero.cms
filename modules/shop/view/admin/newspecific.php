<form action="" method="post">
    <div class="a030_header_block">
        ...
        <button name="save_boot" value="save" class="a030_add_button">
            Сохранить
        </button>
    </div>
    <div id="box_msg">    
        <!-- Успешно -->
        <div class="a030_toast a030_toast_success">
            <span class="a030_toast_icon">✔</span>
            <span class="a030_toast_text">Данные успешно сохранены</span>
        </div>

        <!-- Ошибка -->
        <div class="a030_toast a030_toast_error">
            <span class="a030_toast_icon">✖</span>
            <span class="a030_toast_text">Ошибка сохранения</span>
        </div>
    </div>
    ...
    <div class="a030_form_box_in_user">
        <div class="a030_form_box">
            <div class="a030_input_group">                
                ...
                <div class="a030_input_wrapper">
                    <select class="a030_input_field_select" name="unit">
                    ...
                    <div class="a030_error_text hd">Пожалуйста, выберите значение</div>
                </div>
            </div>
            </div>
            <div class="a030_input_group">
...
.a030_input_textarea:focus + .a006_input_label {
    color: #2F6BF2;
}
...
.a030_input_field:focus + .a008_input_label {
    color: #2F6BF2;
}
...
.a030_has_error .a008_input_label {
  color: #FF4D4F;
}
