<div class="b009_error full_height_wrapper">
    <div class="container">
        <div class="b009_error_hero_wrapper">
            <div class="b009_error_hero_duble">
                <h1 class="b009_error_hero_title_ban">Не удалось подтвердить почту</h1>           
            </div>
